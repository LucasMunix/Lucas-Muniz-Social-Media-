...
document.querySelectorAll('.service-card, .tool-card, .niche-card, .highlight-card, .contact-card').forEach(el => {
    el.style.opacity = '0';
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    whatsappButtons.forEach(button => {
        if (button.textContent.includes('WhatsApp') || button.textContent.includes('Proposta') || button.textContent.includes('Mensagem')) {
            button.addEventListener('click', function(e) {
                e.preventDefault();
                // Mensagem pré-definida para WhatsApp
                const message = encodeURIComponent('Olá Lucas! Vi seu portfólio e gostaria de saber mais sobre seus serviços de Social Media.');
                // Substitua pelo número real do WhatsApp (formato: 5511999999999)
                const phoneNumber = '5511999999999'; // Exemplo - substituir pelo número real
